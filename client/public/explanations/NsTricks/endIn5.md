When multuplying two numbers ending in 5 $A5 \times B5$ First average A and B, and then add that to the product of A and B, write that down, then write down 25 at the end.
